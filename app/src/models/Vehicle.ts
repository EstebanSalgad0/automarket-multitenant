import { BaseModel, VehicleStatus } from './BaseModel';
import type { ValidationResult, ValidationError, MultiTenantModel } from './BaseModel';
...
/**
 * Constantes específicas para vehículos
 */
